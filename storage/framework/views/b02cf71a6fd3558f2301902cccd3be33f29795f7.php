...
<form class="form-horizontal panel panel-default" action="<?php echo e(url('/')); ?>/admin/dealer/books/add-action" style="width:50%;padding: 20px;" method="POST" enctype="multipart/form-data">
    ...
    <div class="form-group">
     ...
     <div class="form-group row">
        ...
        <div class="col-md-9">
            <input type="text" id="author" class="form-control" value="<?php echo e(old('title')); ?>" name="author">
        </div>
    </div>
    <div class="form-group row">
